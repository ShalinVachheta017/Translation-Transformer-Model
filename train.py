...
# function to get all the sentences from the dataset
...
# funtion to get  or build the tokenizer for the dataset
...
def get_model(config, vocab_src_len, vocab_tgt_len):
    """
    Builds a transformer model based on the given configuration and vocab sizes.
    ...
    Returns:
        model (nn.Module): The built transformer model.
    """
    model = build_transformer(
        vocab_src_len, vocab_tgt_len, config['seq_len'], config['seq_len'], config['d_model'])
    return model
